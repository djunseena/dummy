...
public class Attendance implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "generator_attendance_attendance_id_seq")
	@SequenceGenerator(name = "generator_attendance_attendance_id_seq", sequenceName = "attendance_attendance_id_seq", schema = "public", allocationSize = 1)
